...
bot = telebot.TeleBot('7324603047:AAFAWcYakaJzHMVHPUDqVRN5jRZSNVGPvMs')
...
def handle_aadi2(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            aadi2_cooldown[user_id] = datetime.datetime.now()
...
# Add /mylogs command to display logs recorded for aadi2 and website commands
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ғʀᴏᴍ https://t.me/user_x_dead
